...
import com.example.linteacher.api.pojo.artical.LatestAllArticleResponseItem
...
class FeedDataSource : PageKeyedDataSource<Long, Response>() {
    /*
   ...
   */
    override fun loadInitial(
        ...
        val url = String.format(Config.GET_LATEST_ARTICLE, 0)
   ...
   */
    override fun loadAfter(
        ...
        networkState.postValue(NetworkState.LOADING)
        val url = String.format(Config.GET_LATEST_ARTICLE, params.key - 1)
        RetrofitManager.compositeDisposable.add(
            RetrofitManager.apiServices.getLatestList(url)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
